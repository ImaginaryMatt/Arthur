...
if __name__ == "__main__":
    ...
    TCP_IP = '192.168.50.100'  # Replace with your server's IP address
    ...
    try:
        while True:
            ...
            left_y_axis = smooth_joystick(joystick.get_axis(1), deadzone=0.1, expo=3.0, max_output=0.9) * 255 + 255
            right_y_axis = smooth_joystick(joystick.get_axis(3), deadzone=0.1, expo=3.0, max_output=0.8) * 255 + 255
