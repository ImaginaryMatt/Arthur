...
def run_gui():
    ...
    #Building GUI Window
    column_1 = [
                [sg.Text('Is the Robot Active?',font=('Calibri',24))],
                [sg.Text(key='-OUTPUT1-',font=('Calibri',24))],
                [sg.Text('Any Timers Running?',font=('Calibri',24))],
                [sg.Text(key='-OUTPUT6-',font=('Calibri',24))]]

    column_2 = [
                [sg.Text('Socket 1',font=('Calibri',24))],
                [sg.Text(key='-OUTPUT2-',font=('Calibri',24))],
                [sg.Text('Socket 5',font=('Calibri',24))],
                [sg.Text(key='-OUTPUT7-',font=('Calibri',24))]]

    column_3 = [
                [sg.Text('Socket 2',font=('Calibri',24))],
                [sg.Text(key='-OUTPUT3-',font=('Calibri',24))],
                [sg.Text('Socket 6',font=('Calibri',24))],
                [sg.Text(key='-OUTPUT8-',font=('Calibri',24))]]

    column_4 = [
                [sg.Text('Socket 3',font=('Calibri',24))],
                [sg.Text(key='-OUTPUT4-',font=('Calibri',24))],
                [sg.Text('Socket 7',font=('Calibri',24))],
                [sg.Text(key='-OUTPUT9-',font=('Calibri',24))]]

    column_5 = [
                [sg.Text('Socket 4',font=('Calibri',24))],
                [sg.Text(key='-OUTPUT5-',font=('Calibri',24))],
                [sg.Text('Socket 8',font=('Calibri',24))],
                [sg.Text(key='-OUTPUT10-',font=('Calibri',24))]]

    layout = [[sg.Column(column_1), sg.Column(column_2), sg.Column(column_3), sg.Column(column_4), sg.Column(column_5)]]
